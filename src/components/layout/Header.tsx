...
export function Header({ onMenuToggle }: HeaderProps) {
  return (
    <header className="fixed inset-x-0 top-0 z-50 border-b border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900">
      <div className="mx-auto flex h-14 max-w-5xl items-center justify-between px-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="ml-1 rounded-lg p-2 text-gray-500 hover:bg-gray-100 md:hidden dark:text-gray-400 dark:hover:bg-gray-800"
          >
