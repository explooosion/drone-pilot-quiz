  ...
  return (
    <footer className="border-t border-gray-200 bg-white px-4 py-5 pb-[calc(1.25rem+env(safe-area-inset-bottom))] dark:border-gray-800 dark:bg-gray-900">
      <div className="mx-auto flex max-w-5xl flex-col items-center gap-3 text-center">
        ...
        <div>
          <p className="mb-1.5 text-[10px] tracking-wide text-gray-400 uppercase dark:text-gray-600">
            題庫更新日期
          </p>
          <div className="grid grid-cols-3 divide-x divide-gray-200 dark:divide-gray-700">
            {DATES.map(({ label, date }) => (
              <div key={label} className="px-3 first:pl-0 last:pr-0">
                ...
                <p className="text-xs font-medium text-gray-600 tabular-nums dark:text-gray-300">
                  {date}
                </p>
              </div>
            ))}
